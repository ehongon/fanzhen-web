    ...
    <div className="min-h-screen bg-ink">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.div
          ...
          className="rounded-xl border border-gold/20 bg-gradient-to-br from-ink/80 to-ink/60 p-6 md:p-8"
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-rice/60">组建你的修炼小组，邀请道友共同进步</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <Textarea
                ...
                className="bg-ink/50 border-gold/20 text-rice placeholder:text-rice/40 min-h-[100px]"
                maxLength={200}
              />
            </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      selectedType === type
                        ...
                        : "border-gold/10 bg-ink/40 hover:border-gold/30"
                    )}
                  >
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                {TEAM_LEVEL_CONFIG.map((config) => (
                  ...
                  >
                    ...
                    <div className="text-sm font-medium text-rice">{config.name}</div>
                    <div className="text-xs text-rice/50">{config.maxMembers}人</div>
                  </button>
                ))}
              </div>
